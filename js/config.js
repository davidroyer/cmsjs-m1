$(function() {
  ...
  CMS.init({
    ...
    siteName: 'CMS-JS Mach1',

    // Tagline for your site
    siteTagline: 'Build Something Great...Then Make It Even Better',

    // Email address
    siteEmail: 'droyer01@gmail.com',

    // Name
    siteAuthor: 'David Royer',

    // Navigation items
    siteNavItems: [
      { name: 'Github', href: 'https://github.com/davidroyer', newWindow: false},
      { name: 'About'}
    ],
